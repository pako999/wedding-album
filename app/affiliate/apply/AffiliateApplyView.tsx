...
export function affiliateApplyMetadata(lang: AffiliateLang): Metadata {
  ...
  return {
    ...
    alternates: {
      canonical: `https://guestcam.si${localizedPath}`,
      languages: {
        sl: "https://guestcam.si/affiliate/apply",
        hr: "https://guestcam.si/hr/affiliate/apply",
        sr: "https://guestcam.si/sr/affiliate/apply",
        de: "https://guestcam.si/de/affiliate/apply",
        en: "https://guestcam.si/en/affiliate/apply",
        es: "https://guestcam.si/es/affiliate/apply",
        "x-default": "https://guestcam.si/affiliate/apply",
      },
    },
