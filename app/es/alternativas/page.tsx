...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://guestcam.si/es/alternativas",
    languages: {
...
const articleSchema = {
  ...
  mainEntityOfPage: "https://guestcam.si/es/alternativas",
};
    ...
    <footer className="bg-[#0F1729] text-white py-8 mt-20">
      <div className="max-w-5xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-gray-400">
        ...
        <div className="flex items-center gap-5">
          ...
          <a href="mailto:hello@guestcam.si" className="hover:text-white transition-colors">Contacto</a>
        </div>
      </div>
    </footer>
  );
