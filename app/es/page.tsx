...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", locale: "es_ES", siteName: "Guestcam", url: spanishGuestcamUrl("/es"), title: "Código QR para fotos de boda · Sin app · Gratis | Guestcam", description: "Reúne todas las fotos y vídeos de tus invitados con un código QR en una galería privada. Sin app, calidad completa, gratis para empezar. Para bodas.", images: [ogImage("Código QR para fotos de boda · Sin app · Gratis | Guestcam", "es")] },
  twitter: { card: "summary_large_image", title: "Código QR para fotos de boda · Sin app · Gratis | Guestcam", description: "Reúne todas las fotos y vídeos de tus invitados con un código QR en una galería privada. Sin app, calidad completa, gratis para empezar.", images: [localizedOgImageUrl("es")] },
};
