...
import { SPANISH_GUESTCAM_ORIGIN, spanishGuestcamUrl } from "@/lib/site-domains";
...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", locale: "es_ES", siteName: "Guestcam", url: spanishGuestcamUrl("/es"), title: "Código QR para fotos de boda · Sin app · Gratis | Guestcam", description: "Reúne todas las fotos y vídeos de tus invitados con un código QR en una galería privada. Sin app, calidad completa, gratis para empezar. Para bodas.", images: [{ url: `${SPANISH_GUESTCAM_ORIGIN}/og-image-es.jpg?v=1`, width: 910, height: 1200, alt: "Código QR para fotos de boda · Sin app · Gratis | Guestcam", type: "image/jpeg" }] },
  twitter: { card: "summary_large_image", title: "Código QR para fotos de boda · Sin app · Gratis | Guestcam", description: "Reúne todas las fotos y vídeos de tus invitados con un código QR en una galería privada. Sin app, calidad completa, gratis para empezar.", images: [`${SPANISH_GUESTCAM_ORIGIN}/og-image-es.jpg?v=1`] },
};
