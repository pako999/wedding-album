...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.guestcam.si/es/fotos-boda-qr",
    languages: {
...
export default function FotosBodaQrPage() {
  return (
    <div className="min-h-screen bg-[#F2F4F8] text-[#0F1729] font-sans">
      <GuideArticleJsonLd
        headline="Código QR para boda: recopila todas las fotos de tus invitados"
        description="Guía para recopilar todas las fotos de boda con un código QR, sin app y en calidad original."
        inLanguage="es-ES"
        path="/es/fotos-boda-qr"
      />
