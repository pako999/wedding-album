        ...
        <section className="mb-12 -mx-6 px-6 py-12 bg-[#FFF9EC]">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xs text-gray-400 mt-3 text-center">
              Podatki temeljijo na javnih funkcijah januarja 2026. »Delno« pomeni, da funkcija obstaja, a z bistvenimi omejitvami za porocne primere uporabe.
            </p>
          </div>
        </section>
