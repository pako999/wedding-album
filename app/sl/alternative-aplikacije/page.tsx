...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://guestcam.si/sl/alternative-aplikacije",
    languages: {
...
const articleSchema = {
  ...
  mainEntityOfPage: "https://guestcam.si/sl/alternative-aplikacije",
};
    ...
    <header className="sticky top-0 z-40 bg-white border-b border-gray-100">
      <nav className="max-w-5xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3 sm:gap-5 text-sm font-medium text-gray-500">
          <LanguageSwitcher current="sl" languages={ALTERNATIVES_HREFLANG} ariaLabel="Spremeni jezik" />
          <Link href="/" className="hidden sm:inline hover:text-[#0F1729] transition-colors">Domov</Link>
          <Link
            href="/dashboard/new"
