...
export default function QrKodaPorokaPage() {
  return (
    <div className="min-h-screen bg-[#F2F4F8] text-[#0F1729] font-sans">
      <GuideArticleJsonLd
        headline="QR koda za poroko: zberite vse fotografije gostov"
        description="Vodnik za zbiranje poročnih fotografij gostov z eno QR kodo, brez aplikacije in v polni kakovosti."
        inLanguage="sl-SI"
        path="/sl/qr-koda-poroka"
      />
      <SiteHeader lang="sl" hreflang={GUIDE_HREFLANG} />
