...
export const metadata: Metadata = {
  ...
  openGraph: {
    type: "website", locale: "en_GB", siteName: "Guestcam", url: `${SITE_URL}/en`,
    title: "Wedding Photo Sharing App with QR Code · Free | Guestcam",
    description: "Collect every wedding guest's photos and videos via QR code into one private gallery. No app, full quality, free to start. Built for weddings & events.",
    images: [{ url: `${SITE_URL}/og-image.png?v=2`, width: 910, height: 1200, alt: "Wedding Photo Sharing App with QR Code · Free | Guestcam", type: "image/png" }],
  },
...
export default function EnHomePage() { return <LocalizedGuestcamHomePageV2 lang="en" />; }
