...
function Check() {
  return (
    <svg className="w-5 h-5 mx-auto" style={{ color: "#946D00" }} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2.5}>
    ...
    <div className="min-h-screen bg-[#F2F4F8] text-[#111111] font-sans">
      ...
      <main className="max-w-4xl mx-auto px-6 py-16">
            ...
            <table className="w-full text-sm text-left">
              <thead>
                <tr style={{ background: "#111111" }}>
                  ...
                  <th className="p-4 text-center" style={{ color: "#946D00", fontWeight: 700 }}>CamLove</th>
        ...
        <section className="mb-12 space-y-10">
          ...
          {/* CamLove */}
          <div className="bg-white rounded-3xl border-2 p-7 shadow-sm" style={{ borderColor: "#946D00" }}>
            <div className="flex items-start justify-between gap-4 mb-4">
              <div>
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-bold mb-2" style={{ background: "rgba(255,201,77,0.1)", color: "#946D00" }}>
                  Our pick
                </div>
                ...
                <ul className="space-y-1.5 text-sm text-gray-600">
                  {[
                    ...
                    <li key={item} className="flex gap-2">
                      <svg className="w-3.5 h-3.5 mt-0.5 shrink-0" style={{ color: "#946D00" }} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2.5}>
                        <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                      </svg>
                      {item}
                    </li>
