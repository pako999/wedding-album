...
export default function HochzeitsfotosSammelnPage() {
  return (
    <div className="min-h-screen bg-[#F2F4F8] text-[#0F1729] font-sans">
      <GuideArticleJsonLd
        headline="QR-Code Hochzeit: alle Hochzeitsfotos der Gäste sammeln"
        description="Ratgeber zum Sammeln aller Hochzeitsfotos per QR-Code, ohne App und in voller Auflösung."
        inLanguage="de-DE"
        path="/de/hochzeitsfotos-sammeln"
      />
