...
export const metadata: Metadata = {
  ...
  openGraph: {
    url: `${SITE_URL}/de/hochzeitsfotos-sammeln`,
    title: "QR-Code Hochzeit: Fotos der Gäste sammeln 2026",
    description:
  ...
  return (
    ...
    >
      ...
      <Link
        ...
        style={{ background: "#F4B400", boxShadow: "0 10px 30px rgba(255,201,77,0.35)" }}
      >
      ...
      <main className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="mb-12">
          <div
            ...
            style={{ background: "rgba(255,201,77,0.1)", color: "#8F6900" }}
          >
            ...
            {[
              ...
              <div key={title} className="flex gap-4 p-4 rounded-2xl bg-white border border-gray-100 shadow-sm">
                <div className="w-9 h-9 rounded-xl flex items-center justify-center shrink-0" style={{ background: "rgba(255,201,77,0.1)" }}>
                  <svg className="w-4 h-4" style={{ color: "#8F6900" }} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-600 leading-relaxed mb-6">
            CamLove beseitigt jeden Reibungspunkt. So erlebt es ein Gast:
          </p>
          <div className="space-y-4">
            {[
              ...
              <div key={step} className="flex gap-5">
                <div className="w-10 h-10 rounded-full flex items-center justify-center font-bold text-sm shrink-0 mt-0.5" style={{ background: "#F4B400", color: "#111111" }}>
                  {step}
                </div>
        ...
        <section className="mb-10">
          <h2 className="font-serif text-2xl font-bold text-[#111111] mb-4">
            Warum CamLove die beste Wahl ist
          </h2>
        ...
        <section className="mb-10">
          <h2 className="font-serif text-2xl font-bold text-[#111111] mb-4">
            So richten Sie CamLove in 5 Schritten ein
          </h2>
          <div className="space-y-4">
            {[
              { step: "01", title: "Kostenloses Konto erstellen", desc: "Besuchen Sie camlove.me und klicken Sie auf Galerie kostenlos erstellen. E-Mail-Adresse und Passwort eingeben — dauert weniger als eine Minute." },
              ...
              { step: "03", title: "Kartenvorlage auswählen", desc: "CamLove bietet 8 elegante Vorlagen für QR-Karten — von klassisch bis skandinavisch. Jede Vorlage wird automatisch mit Ihren Namen und dem Datum personalisiert." },
            ...
            {[
              ...
              <li key={i} className="flex gap-3">
                <div className="w-5 h-5 rounded-full flex items-center justify-center shrink-0 mt-0.5" style={{ background: "rgba(255,201,77,0.15)" }}>
                  <svg className="w-3 h-3" style={{ color: "#8F6900" }} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={3}>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-3">
            {[
              { q: "Ist CamLove wirklich kostenlos?", a: "Ja, der Grundplan ist für immer kostenlos — Sie erhalten einen einzigartigen QR-Code und eine Galerie für bis zu 50 Gäste und 200 Fotos. Kostenpflichtige Pläne bieten unbegrenzte Gäste, unbegrenzte Fotos und zusätzliche Funktionen." },
