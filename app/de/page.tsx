...
export const metadata: Metadata = {
  ...
  openGraph: {
    type: "website", locale: "de_DE", siteName: "Guestcam", url: `${SITE_URL}/de`,
    title: "Hochzeitsfotos per QR-Code sammeln · Kostenlos | Guestcam",
    description: "Alle Fotos und Videos Ihrer Gäste in einer privaten Galerie sammeln — per QR-Code. Keine App, volle Qualität, kostenlos starten. Für Hochzeiten & Events.",
    images: [{ url: `${SITE_URL}/og-image.png?v=2`, width: 910, height: 1200, alt: "Hochzeitsfotos per QR-Code sammeln · Kostenlos | Guestcam", type: "image/png" }],
  },
...
export default function DeHomePage() { return <LocalizedGuestcamHomePageV2 lang="de" />; }
