...
export const metadata: Metadata = {
  ...
  alternates: { canonical: `${SITE_URL}/de`, languages: withRegionalHreflang({ sl: `${SITE_URL}/`, hr: `${SITE_URL}/hr`, sr: `${SITE_URL}/sr`, de: `${SITE_URL}/de`, en: `${SITE_URL}/en`, es: `${SITE_URL}/es`, "x-default": `${SITE_URL}/` }) },
