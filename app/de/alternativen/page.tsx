...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.guestcam.si/de/alternativen",
    languages: {
...
const articleSchema = {
  ...
  mainEntityOfPage: "https://www.guestcam.si/de/alternativen",
};
          ...
          <div className="bg-white rounded-3xl border-2 p-7 shadow-sm border-[#FFC94D]">
            ...
            <div className="grid sm:grid-cols-2 gap-4 mb-5">
              ...
              <div>
                ...
                <ul className="space-y-1.5 text-sm text-gray-600">
                  {[
                    "Kostenloser Plan auf 20 Fotos und 30 Tage Zugriff begrenzt",
