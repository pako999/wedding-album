...
const plans: readonly Plan[] = [
  { name: "Free", price: "0 €", desc: "Preizkusi pred nakupom", featured: false, features: ["Do 20 fotografij", "30 dni dostopa", "QR koda", "Zasebna galerija"] },
  { name: "Basic", price: "39 €", desc: "Za manjše dogodke", featured: false, features: ["Fotografije v polni kakovosti", "Zasebna galerija", "QR koda", "ZIP prenos"] },
  ...
  { name: "Premium", price: "99 €", desc: "Za večje dogodke", featured: false, features: ["Fotografije + videi", "Live Photo Wall", "Premium QR dizajni", "1 leto dostopa", "Prednostna podpora"] },
];

export default function CamLoveLiveV2Page() {
  return (
    <>
