      ...
      <main className="max-w-4xl mx-auto px-6 py-16">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="overflow-x-auto rounded-2xl border border-gray-200 shadow-sm bg-white">
              <table className="w-full text-sm text-left">
                ...
                <tbody>
                  {[
                    { feature: "Bez aplikacije za goste", wa: true, gp: false, wp: false, db: "partial", gpNote: "Nalog potreban", wpNote: "Aplikacija potrebna", dbNote: "Nalog može biti potreban" },
                    { feature: "Pun originalni kvalitet", wa: true, gp: "partial", wp: "partial", db: true, wpNote: "Zavisi od načina slanja", gpNote: "Zavisi od podešavanja" },
            ...
            <p className="text-xs text-gray-400 mt-3 text-center">
              Podaci se zasnivaju na javno dostupnim funkcijama u avgustu 2026. »Delimično« znači da funkcija zavisi od podešavanja, naloga ili načina slanja.
            </p>
          </div>
        </section>
          ...
          <div className="bg-white rounded-3xl border border-gray-200 p-7 shadow-sm">
            ...
            <div className="grid sm:grid-cols-2 gap-4 mb-5">
              ...
              <div>
                ...
                <ul className="space-y-1.5 text-sm text-gray-600">
                  {[
                    "Kvalitet fotografija zavisi od izabranog načina slanja",
        ...
        <section className="mb-12">
          ...
          <div className="grid gap-3 mb-6">
            {[
              { name: "WhatsApp", problem: "Kvalitet fotografija zavisi od podešavanja i načina slanja." },
