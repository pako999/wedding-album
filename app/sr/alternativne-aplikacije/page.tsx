...
const articleSchema = {
  ...
  mainEntityOfPage: "https://guestcam.si/sr/alternativne-aplikacije",
};
    ...
    <header className="sticky top-0 z-40 bg-white border-b border-gray-100">
      <nav className="max-w-5xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3 sm:gap-5 text-sm font-medium text-gray-500">
          <LanguageSwitcher current="sr" languages={ALTERNATIVES_HREFLANG} ariaLabel="Promeni jezik" />
          ...
          <div className="bg-white rounded-3xl border-2 p-7 shadow-sm border-[#FFC94D]">
            ...
            <div className="grid sm:grid-cols-2 gap-4 mb-5">
              ...
              <div>
                ...
                <ul className="space-y-1.5 text-sm text-gray-600">
                  {[
                    "Besplatan paket ograničen na 50 gostiju / 200 fotografija",
