...
export const metadata: Metadata = {
  ...
  openGraph: { url: serbianGuestcamUrl("/sr/gdpr"), title: "Prava prema GDPR-u", description: "Kako da ostvarite prava na pristup, ispravku ili brisanje ličnih podataka.", images: [localizedOgImageUrl("sr")] },
