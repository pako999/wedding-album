...
export const metadata: Metadata = {
  ...
  openGraph: { url: serbianGuestcamUrl("/sr/terms"), title: "Uslovi korišćenja", description: "Pravila korišćenja Guestcam galerija, otpremanja fotografija i plaćenih paketa.", images: [localizedOgImageUrl("sr")] },
