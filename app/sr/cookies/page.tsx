...
export const metadata: Metadata = {
  ...
  openGraph: { url: serbianGuestcamUrl("/sr/cookies"), title: "Politika kolačića", description: "Pregled Guestcam kolačića i mogućnosti upravljanja podešavanjima.", images: [localizedOgImageUrl("sr")] },
