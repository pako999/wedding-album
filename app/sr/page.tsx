...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", locale: "sr_RS", siteName: "Guestcam", url: serbianGuestcamUrl("/sr"), title: "QR kod za venčanje · Fotografije gostiju uživo | Guestcam", description: "Sakupite sve fotografije i video snimke gostiju sa venčanja preko QR koda u privatnoj galeriji. Bez aplikacije, pun kvalitet, besplatno za probu.", images: [ogImage("QR kod za venčanje · Fotografije gostiju uživo | Guestcam", "sr")] },
  twitter: { card: "summary_large_image", title: "QR kod za venčanje · Fotografije gostiju uživo | Guestcam", description: "Sakupite sve fotografije i video snimke gostiju sa venčanja preko QR koda u privatnoj galeriji. Bez aplikacije, pun kvalitet, besplatno za probu.", images: [localizedOgImageUrl("sr")] },
};
