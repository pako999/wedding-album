...
export const metadata: Metadata = {
  ...
  openGraph: { url: serbianGuestcamUrl("/sr/privacy"), title: "Politika privatnosti", description: "Kako Guestcam obrađuje i štiti lične podatke korisnika i gostiju.", images: [localizedOgImageUrl("sr")] },
