...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.guestcam.si/hr/qr-kod-vjencanje",
    languages: {
...
export default function QrKodVjencanjePage() {
  return (
    <div className="min-h-screen bg-[#F2F4F8] text-[#0F1729] font-sans">
      <GuideArticleJsonLd
        headline="QR kod za vjenčanje — skupite sve fotografije gostiju"
        description="Vodič za prikupljanje fotografija s vjenčanja jednim QR kodom, bez aplikacije i u punoj kvaliteti."
        inLanguage="hr-HR"
        path="/hr/qr-kod-vjencanje"
      />
