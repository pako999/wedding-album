...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://guestcam.si/hr/alternativne-aplikacije",
    languages: {
...
const articleSchema = {
  ...
  mainEntityOfPage: "https://guestcam.si/hr/alternativne-aplikacije",
};
    ...
    <header className="sticky top-0 z-40 bg-white border-b border-gray-100">
      <nav className="max-w-5xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3 sm:gap-5 text-sm font-medium text-gray-500">
          <LanguageSwitcher current="hr" languages={ALTERNATIVES_HREFLANG} ariaLabel="Promijeni jezik" />
