...
export const metadata: Metadata = {
  ...
  openGraph: {
    type: "website", locale: "hr_HR", siteName: "Guestcam", url: `${SITE_URL}/hr`,
    title: "QR kod za vjenčanje · Fotografije gostiju uživo | Guestcam",
    description: "Skupite sve fotografije i videozapise gostiju s vjenčanja preko QR koda u privatnoj galeriji. Bez aplikacije, puna kvaliteta, besplatno za isprobati.",
    images: [{ url: `${SITE_URL}/og-image.png?v=2`, width: 910, height: 1200, alt: "QR kod za vjenčanje · Fotografije gostiju uživo | Guestcam", type: "image/png" }],
  },
...
export default function HrHomePage() { return <LocalizedGuestcamHomePageV2 lang="hr" />; }
