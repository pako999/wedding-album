...
const COPY: Record<Lang, Copy> = {
  sl: {
    ...
    bodyDone: "Ne bomo vam več pošiljali sporočil. Če ste to storili po pomoti, nam pišite na info@camlove.me.",
    home: "Nazaj na camlove.me",
  },
  hr: {
    title: "Odjava — CamLove",
    ...
    bodyDone: "Više vam nećemo slati poruke. Ako ste ovo učinili greškom, javite nam na info@camlove.me.",
    home: "Natrag na camlove.me",
  },
  sr: {
    title: "Odjava — CamLove",
    ...
    buttonConfirm: "Da, odjavi me",
    headingDone: "Uspešno odjavljeni",
    bodyDone: "Više vam nećemo slati poruke. Ako ste ovo uradili greškom, pišite nam na info@camlove.me.",
    home: "Nazad na camlove.me",
  },
  de: {
    title: "Abmeldung — CamLove",
    ...
    bodyDone: "Sie erhalten keine weiteren E-Mails mehr. Falls dies ein Versehen war, schreiben Sie uns an info@camlove.me.",
    home: "Zurück zu camlove.me",
  },
  en: {
    title: "Unsubscribe — CamLove",
    ...
    bodyDone: "We won't send you any more emails. If this was a mistake, email us at info@camlove.me.",
    home: "Back to camlove.me",
  },
  es: {
    title: "Cancelar suscripción — CamLove",
    ...
    bodyDone: "No te enviaremos más correos. Si fue un error, escríbenos a info@camlove.me.",
    home: "Volver a camlove.me",
  },
};
