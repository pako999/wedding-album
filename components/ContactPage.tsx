...
const COPY: Record<LangCode, ContactCopy> = {
  sl: {
    ...
    faqs: [
      ...
      { q: "Kaj se zgodi, če imamo težave na sam dan poroke?", a: "Pišite nam na hello@guestcam.si ali na WhatsApp — odzivamo se tudi ob koncu tedna. Premium paket vključuje 24/7 podporo na dan dogodka, ko šteje vsaka minuta." },
  ...
  hr: {
    ...
    faqs: [
      ...
      { q: "Što ako imamo problema na sam dan vjenčanja?", a: "Pišite nam na hello@guestcam.si ili WhatsApp — odgovaramo i vikendom. Premium paket uključuje 24/7 podršku na dan događaja, kad svaka minuta broji." },
  ...
  sr: {
    ...
    faqs: [
      ...
      { q: "Šta ako imamo problem na sam dan venčanja?", a: "Pišite nam na hello@guestcam.si ili WhatsApp — odgovaramo i vikendom. Premium paket uključuje 24/7 podršku na dan događaja, kada svaki minut važi." },
  ...
  de: {
    ...
    faqs: [
      ...
      { q: "Was, wenn am Hochzeitstag Probleme auftreten?", a: "Schreiben Sie an hello@guestcam.si oder per WhatsApp — wir antworten auch am Wochenende. Das Premium-Paket beinhaltet 24/7-Support am Veranstaltungstag, wenn jede Minute zählt." },
  ...
  en: {
    ...
    faqs: [
      ...
      { q: "What if something goes wrong on the wedding day itself?", a: "Email hello@guestcam.si or message us on WhatsApp — we reply on weekends too. The Premium plan includes 24/7 event-day support when every minute counts." },
  ...
  es: {
    ...
    faqs: [
      ...
      { q: "¿Y si algo va mal el día de la boda?", a: "Escríbenos a hello@guestcam.si o por WhatsApp — respondemos también los fines de semana. El plan Premium incluye soporte 24/7 el día del evento, cuando cada minuto cuenta." },
