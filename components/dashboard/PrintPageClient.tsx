  ...
  return (
    <div className="min-h-screen" style={{ background: "#F4F6FB" }}>
      ...
      <nav className="no-print bg-white border-b sticky top-0 z-40" style={{ borderColor: "rgba(255,201,77,0.15)" }}>
        <div className="max-w-5xl mx-auto px-6 h-14 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            <span className="text-xs text-gray-400 hidden sm:block">Predloga: <strong className="text-[#111111]">{selected.name}</strong></span>
            <button
      ...
      <main className="no-print max-w-5xl mx-auto px-4 sm:px-6 py-10">
        {/* Header */}
        <div className="mb-8">
          <h1 className="font-serif text-3xl font-light text-[#111111] mb-1">{coupleName}</h1>
          ...
          <div className="lg:w-80 shrink-0">
              ...
              {TEMPLATES.map((tmpl) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div>
                      <p className="font-semibold text-sm text-[#111111]">{tmpl.name}</p>
                      <p className="text-xs text-gray-400 mt-0.5">{tmpl.headline}</p>
                    </div>
                    {isActive && (
                      <div className="ml-auto w-5 h-5 rounded-full flex items-center justify-center shrink-0" style={{ background: "#F4B400" }}>
            ...
            {isPremium ? (
              <div className="mt-6 bg-white rounded-2xl p-4 border border-gray-200">
                <p className="text-xs font-bold text-[#111111] mb-1">✏️ Besedilo na kartici</p>
              ...
              <div className="mt-6 bg-white rounded-2xl p-4 border border-gray-200">
                ...
                <p className="text-[11px] text-gray-400 mb-3">
                  ...
                  <strong className="text-[#111111]">Premium</strong>.
                </p>
                <Link
            ...
            <div className="mt-6 bg-white rounded-2xl p-4 border" style={{ borderColor: "rgba(255,201,77,0.15)" }}>
              <p className="text-xs font-bold text-[#111111] mb-2">💡 Nasveti za tisk</p>
