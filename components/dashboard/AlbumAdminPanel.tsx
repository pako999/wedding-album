        ...
        <div className="flex items-start justify-between mb-6 gap-4">
          ...
          <div className="shrink-0 flex items-center gap-2">
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 px-4 py-2 text-white font-sans text-sm font-bold rounded-xl transition-all duration-200"
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center gap-2 px-4 py-2 border border-[#C9A96E]/30 text-[#2C2825] font-sans text-sm rounded-xl hover:border-[#C9A96E] transition-colors"
            >
              <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
