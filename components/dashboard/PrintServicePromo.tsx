...
export function PrintServicePromo({ slug, lang = "sl", variant = "banner" }: Props) {
  ...
  if (variant === "card") {
    return (
      <div
        ...
        style={{ background: "linear-gradient(180deg,#FFF9EC 0%,#FFFFFF 60%)", borderColor: "rgba(255,201,77,0.45)" }}
      >
        <div className="flex items-start gap-3">
          <div className="flex-1 min-w-0">
            <span className="inline-block text-[10px] font-bold uppercase tracking-widest text-[#C9820A] mb-1">
              {c.eyebrow}
            </span>
        ...
        <Link
          href={href}
          className="mt-auto inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl text-[#0F1729] text-sm font-bold hover:brightness-95 transition-all"
  ...
  return (
    <div
      ...
      style={{
        background: "linear-gradient(120deg,#FFF9EC 0%,#FFFFFF 55%,#FFF9EC 100%)",
        borderColor: "#FFC94D",
