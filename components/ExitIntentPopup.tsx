...
const COPY: Record<LangCode, Copy> = {
  sl: {
    eyebrow: "Samo za vas",
    heading: "Počakajte — 15 % popust na prvo galerijo!",
  ...
  hr: {
    eyebrow: "Samo za vas",
    heading: "Pričekajte — 15 % popusta na prvu galeriju!",
    body: "Ne odlazite praznih ruku. Unesite kod pri kupnji i uštedite na prvom Guestcam paketu.",
    codeLabel: "Vaš kod:",
  ...
  sr: {
    eyebrow: "Samo za vas",
    heading: "Sačekajte — 15 % popusta na prvu galeriju!",
    body: "Ne odlazite praznih ruku. Unesite kod pri kupovini i uštedećete na prvom Guestcam paketu.",
    codeLabel: "Vaš kod:",
  ...
  de: {
    ...
    body: "Gehen Sie nicht mit leeren Händen. Geben Sie den Code beim Kauf ein und sparen Sie bei Ihrem ersten Guestcam-Paket.",
    codeLabel: "Ihr Code:",
  ...
  es: {
    ...
    heading: "¡Espera! 15 % de descuento en tu primera galería.",
    body: "No te vayas con las manos vacías. Introduce el código al pagar y ahorra en tu primer plan de Guestcam.",
    codeLabel: "Tu código:",
    cta: "Crear galería con descuento",
    dismiss: "No, gracias",
    copied: "¡Copiado!",
  },
};
