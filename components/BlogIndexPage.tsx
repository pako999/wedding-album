    ...
    <div className="min-h-screen bg-[#F2F4F8] text-[#111111]">
      ...
      <main className="max-w-6xl mx-auto px-6 py-14">
        ...
        <header className="text-center mb-12">
          <p className="text-xs font-bold uppercase tracking-widest text-[#8F6900] mb-3">Blog</p>
          ...
          >
            <div className="grid md:grid-cols-2">
              <div className="p-8 sm:p-10 order-2 md:order-1">
                <p className="text-[10px] font-bold uppercase tracking-widest text-[#8F6900] mb-3">{t.featured}</p>
                ...
                <span className="text-sm font-bold text-[#8F6900]">{t.readMore}</span>
              </div>
              {featured.coverImage ? (
