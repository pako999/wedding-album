    ...
    "slike-s-poroke": {
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            "Iz naših anonimnih statistik: povprečna poroka z 80 gosti zbere med 800 in 1400 slik prek CamLove QR kode. Vrhunec je večerni ples (največ nalaganj po polnoči).",
          ],
        },
      ],
      faq: [
        ...
        { q: "Koliko časa potrebujem, da postavim QR kodo za slike s poroke?",
          a: "S platformo CamLove pod 2 minuti. Vpišete ime para in datum, prenesete QR kodo v PDF-ju, natisnete kartice za mize." },
        { q: "Ali morajo gostje prenesti aplikacijo?",
          a: "Ne. CamLove deluje v brskalniku. Gost skenira QR kodo s kamero telefona in takoj naloži slike." },
      ],
    ...
    "qr-koda-za-poroko": {
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            "Postopek s platformo CamLove traja pod 2 minuti in ne zahteva kreditne kartice:",
          ],
          bullets: [
            "1. Odprite camlove.me in kliknite »Ustvari galerijo«.",
      ...
      faq: [
        { q: "Ali je QR koda za poroko brezplačna?",
          a: "S platformo CamLove je osnovni paket brezplačen — do 20 slik. Za polni doživeti večer priporočamo Plus paket (49€) ali Premium (99€)." },
    ...
    "porocni-album": {
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            "S platformo CamLove se galerija postavi pod 2 minutah:",
          ],
          bullets: [
      ...
      faq: [
        ...
        { q: "Kje se shranijo slike digitalnega albuma?",
          a: "Pri platformi CamLove so podatki na strežnikih v EU (Bunny.net CDN + Neon PostgreSQL). Vaša galerija ni javna in ni indeksirana v Googlu." },
    ...
    "zbiranje-slik-s-poroke": {
      ...
      sections: [
        ...
        },
        {
          ...
          bullets: [
            "Postavite CamLove galerijo in preizkusite QR kodo.",
    ...
    "slike-z-rojstnega-dne": {
      ...
      faq: [
        ...
        { q: "Ali lahko rojstnodnevno galerijo prikažemo na TV med praznovanjem?",
          a: "Da, CamLove Premium omogoča Live prikaz na velikem zaslonu. Slike se pojavijo takoj, ko jih gostje pošljejo." },
        { q: "Koliko časa ostanejo slike na voljo?",
    ...
    "slike-s-poroke": {
      ...
      sections: [
        ...
        { h2: "Koliko fotografija gosti stvarno učitaju",
          paragraphs: ["Iz naših anonimnih statistika: prosječno vjenčanje s 80 gostiju skupi između 800 i 1400 fotografija putem CamLove QR koda. Vrhunac je večernji ples (najviše učitavanja nakon ponoći)."] },
      ],
      faq: [
        ...
        { q: "Koliko vremena treba za postavljanje QR koda za fotografije s vjenčanja?",
          a: "S platformom CamLove manje od 2 minute. Upišete imena para i datum, preuzmete QR kod u PDF-u, isprintate kartice za stolove." },
        { q: "Moraju li gosti preuzeti aplikaciju?",
          a: "Ne. CamLove radi u pregledniku. Gost skenira QR kod kamerom mobitela i odmah učitava fotografije." },
      ],
    ...
    "qr-koda-za-poroko": {
      ...
      sections: [
        ...
        { h2: "Kako stvoriti QR kod za vjenčanje u 5 koraka",
          paragraphs: ["Postupak s platformom CamLove traje manje od 2 minute i ne traži kreditnu karticu:"],
          bullets: [
            "1. Otvorite camlove.me i kliknite »Kreiraj galeriju«.",
      ...
      faq: [
        { q: "Je li QR kod za vjenčanje besplatan?",
          a: "S platformom CamLove je osnovni paket besplatan — do 20 fotografija. Za cijelu večer preporučujemo Plus paket (49€) ili Premium (99€)." },
    ...
    "porocni-album": {
      ...
      sections: [
        ...
        { h2: "Kako pokrenuti digitalni vjenčani album",
          paragraphs: ["S platformom CamLove galerija se postavlja za manje od 2 minute:"],
          bullets: [
      ...
      faq: [
        ...
        { q: "Gdje se pohranjuju fotografije digitalnog albuma?",
          a: "Kod platforme CamLove podaci su na serverima u EU (Bunny.net CDN + Neon PostgreSQL). Vaša galerija nije javna i nije indeksirana u Googleu." },
    ...
    "zbiranje-slik-s-poroke": {
      ...
      sections: [
        ...
        { h2: "Kako pripremiti skupljanje prije vjenčanja",
          ...
          bullets: [
            "Postavite CamLove galeriju i testirajte QR kod.",
    ...
    "slike-z-rojstnega-dne": {
      ...
      faq: [
        ...
        { q: "Možemo li rođendansku galeriju prikazati na TV-u tijekom slavlja?",
          a: "Da, CamLove Premium omogućuje Live prikaz na velikom ekranu. Fotografije se pojave odmah kad ih gosti pošalju." },
        { q: "Koliko dugo fotografije ostaju dostupne?",
    ...
    "baby-shower-slike": {
      ...
      sections: [
        ...
        { h2: "Kako postaviti galeriju za baby shower",
          paragraphs: ["Postupak s platformom CamLove:"],
          bullets: [
  ...
  sr: {
    "slike-s-poroke": {
      ...
      sections: [
        ...
        { h2: "Koliko slika gosti stvarno otpreme",
          paragraphs: ["Iz naših anonimnih statistika: prosečno venčanje sa 80 gostiju sakupi između 800 i 1400 slika preko CamLove QR koda. Vrhunac je večernji ples (najviše otpremanja posle ponoći)."] },
      ],
      faq: [
        ...
        { q: "Koliko vremena treba za postavljanje QR koda za slike sa venčanja?",
          a: "Sa platformom CamLove manje od 2 minuta. Upišete imena para i datum, preuzmete QR kod u PDF-u, odštampate kartice za stolove." },
        { q: "Moraju li gosti da preuzmu aplikaciju?",
          a: "Ne. CamLove radi u pretraživaču. Gost skenira QR kod kamerom telefona i odmah otprema slike." },
      ],
    ...
    "qr-koda-za-poroko": {
      ...
      sections: [
        ...
        { h2: "Kako napraviti QR kod za venčanje u 5 koraka",
          paragraphs: ["Postupak sa platformom CamLove traje manje od 2 minuta i ne traži kreditnu karticu:"],
          bullets: [
            "1. Otvorite camlove.me i kliknite »Kreiraj galeriju«.",
      ...
      faq: [
        { q: "Da li je QR kod za venčanje besplatan?",
          a: "Sa platformom CamLove je osnovni paket besplatan — do 20 slika. Za celu večer preporučujemo Plus paket (49€) ili Premium (99€)." },
    ...
    "porocni-album": {
      ...
      sections: [
        ...
        { h2: "Kako pokrenuti digitalni venčani album",
          paragraphs: ["Sa platformom CamLove galerija se postavlja za manje od 2 minuta:"],
          bullets: [
      ...
      faq: [
        ...
        { q: "Gde se čuvaju slike digitalnog albuma?",
          a: "Kod platforme CamLove podaci su na serverima u EU (Bunny.net CDN + Neon PostgreSQL). Vaša galerija nije javna i nije indeksirana u Google-u." },
    ...
    "slike-z-rojstnega-dne": {
      ...
      faq: [
        ...
        { q: "Možemo li rođendansku galeriju da prikažemo na TV-u tokom slavlja?",
          a: "Da, CamLove Premium omogućava Live prikaz na velikom ekranu. Slike se pojave odmah kad ih gosti pošalju." },
        { q: "Koliko dugo slike ostaju dostupne?",
    ...
    "baby-shower-slike": {
      ...
      sections: [
        ...
        { h2: "Kako postaviti galeriju za baby shower",
          paragraphs: ["Postupak sa platformom CamLove:"],
          bullets: [
    ...
    "slike-s-poroke": {
      ...
      sections: [
        ...
        { h2: "Wie viele Fotos Gäste tatsächlich hochladen",
          paragraphs: ["Aus unseren anonymen Statistiken: eine durchschnittliche Hochzeit mit 80 Gästen sammelt zwischen 800 und 1400 Fotos über den CamLove QR-Code. Spitze ist der Abend-Tanz (die meisten Uploads nach Mitternacht)."] },
      ],
      faq: [
        ...
        { q: "Wie lange dauert die Einrichtung eines QR-Codes für Hochzeitsfotos?",
          a: "Mit CamLove unter 2 Minuten. Namen des Paares und Datum eingeben, QR-Code als PDF herunterladen, Tischkarten drucken." },
        { q: "Müssen Gäste eine App herunterladen?",
          a: "Nein. CamLove läuft im Browser. Der Gast scannt den QR-Code mit der Handy-Kamera und lädt sofort hoch." },
      ],
    ...
    "qr-koda-za-poroko": {
      ...
      sections: [
        ...
        { h2: "So erstellen Sie den QR-Code in 5 Schritten",
          paragraphs: ["Der Prozess mit CamLove dauert unter 2 Minuten und braucht keine Kreditkarte:"],
          bullets: [
            "1. camlove.me öffnen, „Galerie erstellen“ anklicken.",
      ...
      faq: [
        { q: "Ist der QR-Code für die Hochzeit kostenlos?",
          a: "Mit CamLove ist das Basis-Paket kostenlos — bis zu 20 Fotos. Für den vollen Abend empfehlen wir Plus (49 €) oder Premium (99 €)." },
    ...
    "porocni-album": {
      ...
      sections: [
        ...
        { h2: "So starten Sie das digitale Hochzeitsalbum",
          paragraphs: ["Mit CamLove ist die Galerie in unter 2 Minuten eingerichtet:"],
          bullets: [
      ...
      faq: [
        ...
        { q: "Wo werden die Fotos des digitalen Albums gespeichert?",
          a: "Bei CamLove auf EU-Servern (Bunny.net CDN + Neon PostgreSQL). Ihre Galerie ist nicht öffentlich und wird bei Google nicht indexiert." },
    ...
    "zbiranje-slik-s-poroke": {
      ...
      sections: [
        ...
        { h2: "So bereiten Sie das Einsammeln vor der Hochzeit vor",
          ...
          bullets: [
            "CamLove-Galerie einrichten und QR-Code testen.",
    ...
    "slike-z-rojstnega-dne": {
      ...
      faq: [
        ...
        { q: "Können wir die Geburtstagsgalerie während der Feier auf dem TV zeigen?",
          a: "Ja, CamLove Premium bietet Live-Anzeige auf einem großen Bildschirm. Fotos erscheinen sofort, sobald Gäste sie hochladen." },
    ...
    "baby-shower-slike": {
      ...
      sections: [
        ...
        { h2: "So richten Sie die Galerie ein",
          paragraphs: ["Prozess mit CamLove:"],
          bullets: [
    ...
    "slike-s-poroke": {
      ...
      sections: [
        ...
        { h2: "How many photos guests actually upload",
          paragraphs: ["From our anonymous stats: an average wedding with 80 guests collects between 800 and 1400 photos via CamLove's QR code. Peak is the evening dance floor (most uploads after midnight)."] },
      ],
      faq: [
        ...
        { q: "How long does it take to set up a wedding QR code?",
          a: "Under 2 minutes with CamLove. Enter the couple's names and date, download the QR code as PDF, print table cards." },
        { q: "Do guests need to download an app?",
          a: "No. CamLove runs in the browser. A guest scans the QR code with the phone's camera and uploads immediately." },
      ],
    ...
    "qr-koda-za-poroko": {
      ...
      sections: [
        ...
        { h2: "How to create a wedding QR code in 5 steps",
          paragraphs: ["The process with CamLove takes under 2 minutes and asks for no credit card:"],
          bullets: [
            "1. Open camlove.me and click “Create gallery”.",
      ...
      faq: [
        { q: "Is a wedding QR code free?",
          a: "With CamLove the basic plan is free — up to 20 photos. For a full evening we recommend Plus (€49) or Premium (€99)." },
    ...
    "porocni-album": {
      ...
      sections: [
        ...
        { h2: "How to start a digital wedding album",
          paragraphs: ["With CamLove the gallery goes live in under 2 minutes:"],
          bullets: [
      ...
      faq: [
        ...
        { q: "Where are the digital album's photos stored?",
          a: "At CamLove on servers in the EU (Bunny.net CDN + Neon PostgreSQL). Your gallery is private and never indexed by Google." },
    ...
    "zbiranje-slik-s-poroke": {
      ...
      sections: [
        ...
        { h2: "How to prepare the collection before the wedding",
          ...
          bullets: [
            "Set up the CamLove gallery and test the QR code.",
    ...
    "slike-z-rojstnega-dne": {
      ...
      faq: [
        ...
        { q: "Can we show the birthday gallery on the TV during the party?",
          a: "Yes, CamLove Premium supports Live projection on a big screen. Photos appear the moment guests upload them." },
        { q: "How long do the photos stay available?",
    ...
    "slike-s-poroke": {
      ...
      sections: [
        ...
        { h2: "Cuántas fotos suben los invitados de verdad",
          paragraphs: ["De nuestras estadísticas anónimas: una boda media con 80 invitados recopila entre 800 y 1400 fotos por el código QR de CamLove. El pico es el baile nocturno (más subidas después de medianoche)."] },
      ],
      faq: [
        ...
        { q: "¿Cuánto tarda montar un código QR para fotos de boda?",
          a: "Con CamLove menos de 2 minutos. Introduces nombres y fecha, descargas el QR en PDF e imprimes las tarjetas para las mesas." },
        { q: "¿Los invitados tienen que descargar una app?",
          a: "No. CamLove funciona en el navegador. El invitado escanea con la cámara del móvil y sube al instante." },
      ],
    ...
    "qr-koda-za-poroko": {
      ...
      sections: [
        ...
        { h2: "Cómo crear el código QR en 5 pasos",
          paragraphs: ["Con CamLove el proceso lleva menos de 2 minutos y no pide tarjeta:"],
          bullets: [
            "1. Entra en camlove.me y pulsa «Crear galería».",
      ...
      faq: [
        { q: "¿Es gratis el código QR para boda?",
          a: "Con CamLove el plan básico es gratis — hasta 20 fotos. Para la noche completa recomendamos Plus (49 €) o Premium (99 €)." },
    ...
    "porocni-album": {
      ...
      sections: [
        ...
        { h2: "Cómo empezar el álbum digital",
          paragraphs: ["Con CamLove la galería está lista en menos de 2 minutos:"],
          bullets: [
      ...
      faq: [
        ...
        { q: "¿Dónde se guardan las fotos del álbum digital?",
          a: "En CamLove, en servidores de la UE (CDN Bunny.net + Neon PostgreSQL). Tu galería no es pública y no se indexa en Google." },
    ...
    "zbiranje-slik-s-poroke": {
      ...
      sections: [
        ...
        { h2: "Cómo preparar la recopilación antes de la boda",
          ...
          bullets: [
            "Monta la galería de CamLove y prueba el QR.",
    ...
    "slike-z-rojstnega-dne": {
      ...
      faq: [
        ...
        { q: "¿Podemos mostrar la galería de cumpleaños en la TV durante la fiesta?",
          a: "Sí, CamLove Premium ofrece proyección en directo en pantalla grande. Las fotos aparecen cuando los invitados suben." },
        { q: "¿Cuánto tiempo están disponibles las fotos?",
