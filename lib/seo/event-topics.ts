    ...
    "qr-koda-za-poroko": {
      ...
      faq: [
        { q: "Ali je QR koda za poroko brezplačna?",
          a: "Z Guestcamom je osnovni paket brezplačen — do 20 slik. Za polni doživeti večer priporočamo Plus paket (49€) ali Poročni premium (99€)." },
        ...
        { q: "Koliko časa ostanejo slike na voljo?",
          a: "Odvisno od paketa — od 30 dni pri brezplačnem do 2 leti pri Poročni premium. V vsakem trenutku lahko prenesete vse slike v ZIP." },
      ],
    ...
    "slike-z-rojstnega-dne": {
      ...
      faq: [
        ...
        { q: "Ali lahko rojstnodnevno galerijo prikažemo na TV med praznovanjem?",
          a: "Da, Guestcam Poročni premium omogoča Live prikaz na velikem zaslonu. Slike se pojavijo takoj, ko jih gostje pošljejo." },
        { q: "Koliko časa ostanejo slike na voljo?",
          a: "Odvisno od paketa — od 30 dni pri brezplačnem do 2 leti pri Poročni premium. Vedno lahko prenesete vse v ZIP." },
      ],
    ...
    "qr-koda-za-poroko": {
      ...
      faq: [
        { q: "Je li QR kod za vjenčanje besplatan?",
          a: "S Guestcamom je osnovni paket besplatan — do 20 fotografija. Za cijelu večer preporučujemo Plus paket (49€) ili Vjenčani premium (99€)." },
        ...
        { q: "Koliko dugo fotografije ostaju dostupne?",
          a: "Ovisno o paketu — od 30 dana kod besplatnog do 2 godine kod Vjenčani premium. U svakom trenutku možete preuzeti sve fotografije u ZIP." },
      ],
    ...
    "slike-z-rojstnega-dne": {
      ...
      faq: [
        ...
        { q: "Možemo li rođendansku galeriju prikazati na TV-u tijekom slavlja?",
          a: "Da, Guestcam Vjenčani premium omogućuje Live prikaz na velikom ekranu. Fotografije se pojave odmah kad ih gosti pošalju." },
        { q: "Koliko dugo fotografije ostaju dostupne?",
          a: "Ovisno o paketu — od 30 dana kod besplatnog do 2 godine kod Vjenčani premium. Uvijek možete preuzeti sve u ZIP." },
      ],
    ...
    "qr-koda-za-poroko": {
      ...
      faq: [
        { q: "Da li je QR kod za venčanje besplatan?",
          a: "Sa Guestcamom je osnovni paket besplatan — do 20 slika. Za celu večer preporučujemo Plus paket (49€) ili Venčani premium (99€)." },
        ...
        { q: "Koliko dugo slike ostaju dostupne?",
          a: "Zavisi od paketa — od 30 dana kod besplatnog do 2 godine kod Venčani premium. U svakom trenutku možete preuzeti sve slike u ZIP." },
      ],
    ...
    "slike-z-rojstnega-dne": {
      ...
      faq: [
        ...
        { q: "Možemo li rođendansku galeriju da prikažemo na TV-u tokom slavlja?",
          a: "Da, Guestcam Venčani premium omogućava Live prikaz na velikom ekranu. Slike se pojave odmah kad ih gosti pošalju." },
        { q: "Koliko dugo slike ostaju dostupne?",
          a: "Zavisi od paketa — od 30 dana kod besplatnog do 2 godine kod Venčani premium. Uvek možete preuzeti sve u ZIP." },
      ],
    ...
    "qr-koda-za-poroko": {
      ...
      faq: [
        { q: "Ist der QR-Code für die Hochzeit kostenlos?",
          a: "Mit Guestcam ist das Basis-Paket kostenlos — bis zu 20 Fotos. Für den vollen Abend empfehlen wir Plus (49 €) oder Hochzeits-Premium (99 €)." },
        ...
        { q: "Wie lange bleiben Fotos verfügbar?",
          a: "Abhängig vom Paket — von 30 Tagen (kostenlos) bis 2 Jahren (Hochzeits-Premium). Sie können jederzeit alle Fotos als ZIP herunterladen." },
      ],
    ...
    "slike-z-rojstnega-dne": {
      ...
      faq: [
        ...
        { q: "Können wir die Geburtstagsgalerie während der Feier auf dem TV zeigen?",
          a: "Ja, Guestcam Hochzeits-Premium bietet Live-Anzeige auf einem großen Bildschirm. Fotos erscheinen sofort, sobald Gäste sie hochladen." },
        { q: "Wie lange bleiben die Fotos verfügbar?",
          a: "Abhängig vom Paket — von 30 Tagen (kostenlos) bis 2 Jahren (Hochzeits-Premium). Sie können jederzeit alles als ZIP herunterladen." },
      ],
    ...
    "qr-koda-za-poroko": {
      ...
      faq: [
        { q: "Is a wedding QR code free?",
          a: "With Guestcam the basic plan is free — up to 20 photos. For a full evening we recommend Plus (€49) or Wedding Premium (€99)." },
        ...
        { q: "How long do the photos stay available?",
          a: "Depending on the plan — from 30 days (free) up to 2 years (Wedding Premium). You can download all photos as a ZIP at any time." },
      ],
    ...
    "slike-z-rojstnega-dne": {
      ...
      faq: [
        ...
        { q: "Can we show the birthday gallery on the TV during the party?",
          a: "Yes, Guestcam Wedding Premium supports Live projection on a big screen. Photos appear the moment guests upload them." },
        { q: "How long do the photos stay available?",
          a: "Depending on plan — from 30 days (free) to 2 years (Wedding Premium). You can download everything as a ZIP any time." },
      ],
    ...
    "qr-koda-za-poroko": {
      ...
      faq: [
        { q: "¿Es gratis el código QR para boda?",
          a: "Con Guestcam el plan básico es gratis — hasta 20 fotos. Para la noche completa recomendamos Plus (49 €) o Premium para bodas (99 €)." },
        ...
        { q: "¿Cuánto tiempo están disponibles las fotos?",
          a: "Depende del plan — de 30 días (gratis) a 2 años (Premium para bodas). Puedes descargar todo como ZIP en cualquier momento." },
      ],
    ...
    "slike-z-rojstnega-dne": {
      ...
      faq: [
        ...
        { q: "¿Podemos mostrar la galería de cumpleaños en la TV durante la fiesta?",
          a: "Sí, Guestcam Premium para bodas ofrece proyección en directo en pantalla grande. Las fotos aparecen cuando los invitados suben." },
        { q: "¿Cuánto tiempo están disponibles las fotos?",
          a: "Depende del plan — de 30 días (gratis) a 2 años (Premium para bodas). Siempre puedes descargar todo en ZIP." },
      ],
