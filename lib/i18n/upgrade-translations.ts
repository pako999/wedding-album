...
export const UPGRADE_COPY: Record<Lang, UpgradeCopy> = {
  sl: {
    ...
    testimonialQuote: "CamLove je bila najboljša odločitev za naš dan. Gostje so naložili čez 300 fotografij — brez aplikacij, brez zapletov. Vse fotografije so bile na enem mestu!",
    ...
    alertInvoiceFailed: "Napaka pri oddaji naročila. Pišite na info@camlove.me",
    alertPaymentFailed: "Napaka pri plačilu. Poskusite znova ali nas kontaktirajte na info@camlove.me",
    ...
    footerCompanyLine: "© 2026 CamLove · Sport group d.o.o. · SI72133449 · Slovenija",
  ...
  hr: {
    ...
    testimonialQuote: "CamLove je bio najbolja odluka za naš dan. Gosti su uploadali preko 300 fotografija — bez aplikacija, bez komplikacija. Sve fotografije na jednom mjestu!",
    testimonialAuthor: "Ana & Marko",
    ...
    alertInvoiceFailed: "Greška pri slanju narudžbe. Pišite na info@camlove.me",
    alertPaymentFailed: "Greška pri plaćanju. Pokušajte ponovno ili nas kontaktirajte na info@camlove.me",
  ...
  sr: {
    ...
    testimonialQuote: "CamLove je bio najbolja odluka za naš dan. Gosti su uploadovali preko 300 fotografija — bez aplikacija, bez komplikacija. Sve fotografije na jednom mestu!",
    testimonialAuthor: "Ana & Marko",
    testimonialMeta: "500+ fotografija · 2026",
    supportTitle: "Imate pitanje?",
    ...
    alertInvoiceFailed: "Greška pri slanju narudžbine. Pišite na info@camlove.me",
    alertPaymentFailed: "Greška pri plaćanju. Pokušajte ponovo ili nas kontaktirajte na info@camlove.me",
  ...
  en: {
    ...
    testimonialQuote: "CamLove was the best decision for our day. Guests uploaded over 300 photos — no apps, no hassle. All the memories in one place!",
    testimonialAuthor: "Ana & Marko",
    ...
    alertInvoiceFailed: "Failed to submit order. Write to info@camlove.me",
    alertPaymentFailed: "Payment failed. Please try again or contact us at info@camlove.me",
    ...
    footerCompanyLine: "© 2026 CamLove · Sport group d.o.o. · SI72133449 · Slovenia",
  ...
  de: {
    ...
    testimonialQuote: "CamLove war die beste Entscheidung für unseren Tag. Die Gäste haben über 300 Fotos hochgeladen — ohne App, ohne Umstände. Alle Erinnerungen an einem Ort!",
    testimonialAuthor: "Ana & Marko",
    ...
    alertInvoiceFailed: "Bestellung konnte nicht gesendet werden. Schreiben Sie an info@camlove.me",
    alertPaymentFailed: "Zahlung fehlgeschlagen. Bitte versuchen Sie es erneut oder kontaktieren Sie uns unter info@camlove.me",
    ...
    footerCompanyLine: "© 2026 CamLove · Sport group d.o.o. · SI72133449 · Slowenien",
  ...
  es: {
    ...
    testimonialQuote: "CamLove fue la mejor decisión para nuestro día. Los invitados subieron más de 300 fotos — sin apps, sin líos. ¡Todos los recuerdos en un solo lugar!",
    testimonialAuthor: "Ana & Marko",
    testimonialMeta: "500+ fotos · 2026",
    ...
    alertInvoiceFailed: "Error al enviar el pedido. Escribe a info@camlove.me",
    alertPaymentFailed: "Error en el pago. Inténtalo de nuevo o contáctanos en info@camlove.me",
    ...
    footerCompanyLine: "© 2026 CamLove · Sport group d.o.o. · SI72133449 · Eslovenia",
