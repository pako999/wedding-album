...
const sl: AffiliateUiStrings = {
  apply: {
    pageTitle: "Postanite CamLove partner — zaslužite 20%",
    metaDescription: "Pridružite se CamLove partnerskemu programu in zaslužite 20% provizije za vsako priporočeno naročilo.",
    badge: "🤝 Partnerski program",
    headingLine1: "Priporočite CamLove.",
    headingLine2: "Zaslužite 20%.",
    subheading: "Pridružite se CamLove partnerskemu programu in zaslužite 20% od vsakega plačanega naročila — za vsako novo sklenitev partnerske povezave.",
    benefits: [
    ...
    formPromotionPlan: "Kako nameravate promovirati CamLove?",
    ...
    errorPromotion: "Prosimo opišite, kako boste promovirali CamLove (vsaj 20 znakov).",
  ...
  dashboard: {
    ...
    contactFooter: "Za vprašanja nam pišite na partnerji@camlove.me",
    ...
    blockedBody: "Za več informacij nam pišite na partnerji@camlove.me.",
    notAffiliateTitle: "Še niste partner",
    notAffiliateBody: "Pridružite se CamLove partnerskemu programu in zaslužite 20% provizije.",
...
const en: AffiliateUiStrings = {
  apply: {
    pageTitle: "Become a CamLove partner — earn 20%",
    metaDescription: "Join the CamLove partner program and earn 20% commission on every referred order.",
    badge: "🤝 Partner program",
    headingLine1: "Recommend CamLove.",
    headingLine2: "Earn 20%.",
    subheading: "Join the CamLove partner program and earn 20% of every paid order — for every new sign-up through your partner link.",
    benefits: [
    ...
    formPromotionPlan: "How will you promote CamLove?",
    ...
    errorPromotion: "Please describe how you'll promote CamLove (at least 20 characters).",
  ...
  dashboard: {
    ...
    contactFooter: "Questions? Email us at partnerji@camlove.me",
    ...
    blockedBody: "For more information, email us at partnerji@camlove.me.",
    notAffiliateTitle: "You're not a partner yet",
    notAffiliateBody: "Join the CamLove partner program and earn 20% commission.",
...
const de: AffiliateUiStrings = {
  apply: {
    pageTitle: "CamLove Partner werden — 20% verdienen",
    metaDescription: "Treten Sie dem CamLove Partnerprogramm bei und verdienen Sie 20% Provision für jede empfohlene Bestellung.",
    badge: "🤝 Partnerprogramm",
    headingLine1: "Empfehlen Sie CamLove.",
    headingLine2: "Verdienen Sie 20%.",
    subheading: "Treten Sie dem CamLove Partnerprogramm bei und verdienen Sie 20% von jeder bezahlten Bestellung — für jede neue Anmeldung über Ihren Partner-Link.",
    benefits: [
    ...
    formPromotionPlan: "Wie werden Sie CamLove bewerben?",
    ...
    errorPromotion: "Bitte beschreiben Sie, wie Sie CamLove bewerben werden (mindestens 20 Zeichen).",
  ...
  dashboard: {
    ...
    contactFooter: "Fragen? Schreiben Sie uns an partnerji@camlove.me",
    ...
    blockedBody: "Für weitere Informationen schreiben Sie uns an partnerji@camlove.me.",
    notAffiliateTitle: "Sie sind noch kein Partner",
    notAffiliateBody: "Treten Sie dem CamLove Partnerprogramm bei und verdienen Sie 20% Provision.",
...
const hr: AffiliateUiStrings = {
  apply: {
    pageTitle: "Postanite CamLove partner — zaradite 20%",
    metaDescription: "Pridružite se CamLove partnerskom programu i zaradite 20% provizije za svaku preporučenu narudžbu.",
    badge: "🤝 Partnerski program",
    headingLine1: "Preporučite CamLove.",
    headingLine2: "Zaradite 20%.",
    subheading: "Pridružite se CamLove partnerskom programu i zaradite 20% od svake plaćene narudžbe — za svaku novu prijavu putem vaše partnerske poveznice.",
    benefits: [
    ...
    formPromotionPlan: "Kako ćete promovirati CamLove?",
    ...
    errorPromotion: "Molimo opišite kako ćete promovirati CamLove (najmanje 20 znakova).",
  ...
  dashboard: {
    ...
    contactFooter: "Pitanja? Pišite nam na partnerji@camlove.me",
    ...
    blockedBody: "Za više informacija pišite nam na partnerji@camlove.me.",
    notAffiliateTitle: "Niste još partner",
    notAffiliateBody: "Pridružite se CamLove partnerskom programu i zaradite 20% provizije.",
    notAffiliateCta: "Prijava →",
  },
  status: {
    pending: "Na čekanju",
...
const sr: AffiliateUiStrings = {
  apply: {
    pageTitle: "Postanite CamLove partner — zaradite 20%",
    metaDescription: "Pridružite se CamLove partnerskom programu i zaradite 20% provizije za svaku preporučenu porudžbinu.",
    badge: "🤝 Partnerski program",
    headingLine1: "Preporučite CamLove.",
    headingLine2: "Zaradite 20%.",
    subheading: "Pridružite se CamLove partnerskom programu i zaradite 20% od svake plaćene porudžbine — za svaku novu prijavu putem vašeg partnerskog linka.",
    benefits: [
    ...
    formPromotionPlan: "Kako ćete promovisati CamLove?",
    formPromotionPlaceholder: "Opišite vašu publiku, kanale (blog, Instagram, YouTube...) i strategiju promocije.",
    ...
    errorPromotion: "Opišite kako ćete promovisati CamLove (najmanje 20 karaktera).",
...
const es: AffiliateUiStrings = {
  apply: {
    pageTitle: "Hazte partner de CamLove — gana 20%",
    metaDescription: "Únete al programa de afiliados de CamLove y gana un 20% de comisión por cada pedido referido.",
    badge: "🤝 Programa de afiliados",
    headingLine1: "Recomienda CamLove.",
    headingLine2: "Gana 20%.",
    subheading: "Únete al programa de afiliados de CamLove y gana el 20% de cada pedido pagado — por cada nuevo registro a través de tu enlace de afiliado.",
    benefits: [
    ...
    formPromotionPlan: "¿Cómo vas a promocionar CamLove?",
    ...
    errorPromotion: "Describe cómo vas a promocionar CamLove (al menos 20 caracteres).",
  ...
  dashboard: {
    ...
    contactFooter: "¿Preguntas? Escríbenos a partnerji@camlove.me",
    ...
    blockedBody: "Para más información, escríbenos a partnerji@camlove.me.",
    notAffiliateTitle: "Aún no eres afiliado",
    notAffiliateBody: "Únete al programa de afiliados de CamLove y gana un 20% de comisión.",
